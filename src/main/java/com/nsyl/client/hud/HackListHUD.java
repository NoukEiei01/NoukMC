...
import com.nsyl.client.other_features.HackListOtf;
import com.nsyl.client.other_features.HackListOtf.Mode;
import com.nsyl.client.other_features.HackListOtf.Position;

public final class HackListHUD implements UpdateListener
{
	private final ArrayList<HackListEntry> activeHax = new ArrayList<>();
	private final HackListOtf otf = NsylClient.INSTANCE.getOtfs().hackListOtf;
	private int posY;
