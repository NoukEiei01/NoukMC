...
{
	private final LocalPlayer player = NsylClient.MC.player;
	private final ClientLevel world = NsylClient.MC.level;
	private PlayerInfo playerListEntry;
	
	public FakePlayerEntity()
	{
		super(NsylClient.MC.level, NsylClient.MC.player.getGameProfile());
