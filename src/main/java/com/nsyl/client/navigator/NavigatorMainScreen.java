...
import com.nsyl.client.clickgui.ClickGuiIcons;
...
public final class NavigatorMainScreen extends NavigatorScreen
{
	...
	public NavigatorMainScreen()
	{
		...
		Navigator navigator = NsylClient.INSTANCE.getNavigator();
		...
		float partialTicks)
	{
		...
		{
			context.drawString(NsylClient.MC.font, "Search: ", middleX - 150,
				32, txtColor);
