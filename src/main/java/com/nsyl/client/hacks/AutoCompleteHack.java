...
import com.nsyl.client.hacks.autocomplete.MessageCompleter;
import com.nsyl.client.hacks.autocomplete.ModelSettings;
import com.nsyl.client.hacks.autocomplete.OpenAiMessageCompleter;
import com.nsyl.client.hacks.autocomplete.SuggestionHandler;
	...
	implements ChatOutputListener, UpdateListener
{
	...
	protected void onEnable()
	{
		...
		if(completer instanceof OpenAiMessageCompleter
			&& System.getenv("NSYL_OPENAI_KEY") == null)
		{
			ChatUtils.error("API key not found. Please set the"
				+ " NSYL_OPENAI_KEY environment variable and reboot.");
			setEnabled(false);
			return;
		}
