 ...
 */
package com.nsyl.client.hacks.autolibrarian;
	...
	implements Comparable<BookOffer>
{
	...
	{
		RegistryAccess drm = NsylClient.MC.level.registryAccess();
	...
	public String getEnchantmentName()
	{
		...
		if(description.getContents() instanceof TranslatableContents tr)
			return NsylClient.INSTANCE.getTranslator()
