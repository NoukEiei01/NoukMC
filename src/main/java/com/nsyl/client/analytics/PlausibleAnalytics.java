 ...
 */
package com.nsyl.client.analytics;
...
public final class PlausibleAnalytics
{
	...
	private static final String MOD_ID = "nsyl";
	...
	public PlausibleAnalytics(Path configFile)
	{
		...
		sessionProp("version", getVersion("nsyl"));
		sessionProp("short_version", getShortVersion("nsyl"));
